...
static void secp256k1_batch_schnorrsig_randomizer_gen(const secp256k1_hash_ctx *hash_ctx, unsigned char *randomizer32, secp256k1_sha256 *sha256, const unsigned char *sig64, const unsigned char *msg, size_t msglen, const unsigned char *compressed_pk33) {
    ...
    secp256k1_sha256_write(hash_ctx, sha256, sig64, 64);
    secp256k1_sha256_write(hash_ctx, sha256, msg, msglen);
    secp256k1_sha256_write(hash_ctx, sha256, compressed_pk33, 33);
...
static int secp256k1_batch_schnorrsig_randomizer_set(const secp256k1_context *ctx, secp256k1_batch *batch, secp256k1_scalar *r, const unsigned char *sig64, const unsigned char *msg, size_t msglen, const secp256k1_xonly_pubkey *pubkey) {
    ...
    * would be the same for two different pubkeys. */
    ...
    secp256k1_batch_schnorrsig_randomizer_gen(hash_ctx, randomizer, &batch->sha256, sig64, msg, msglen, buf);
...
void secp256k1_batch_add_schnorrsig(const secp256k1_context* ctx, secp256k1_batch *batch, const unsigned char *sig64, const unsigned char *msg, size_t msglen, const secp256k1_xonly_pubkey *pubkey) {
    ...
    secp256k1_schnorrsig_challenge(hash_ctx, &e, &sig64[0], msg, msglen, buf);
